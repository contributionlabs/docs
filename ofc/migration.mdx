...
<Warning>
  For the smoothest experience, load the page using a dedicated desktop or mobile browser such as Chrome, Firefox, Safari, etc. Do not use an in-app browser like Twitter or wallet-based in-app browser.
</Warning>
...
The instructions for S1 and S2 are the same:
